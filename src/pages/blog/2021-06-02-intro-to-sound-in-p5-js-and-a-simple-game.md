...
This uses your microphone as input for a sound visualizer, its based on an example P5.JS.org. if it does not load for you try [This Link](https://lukeknight00.github.io/pages/sketches/FrequencyIntensity/)

<iframe src="https://editor.p5js.org/Lukeknight00/embed/Iyfz4kQN9" style="width:80vw;height:60vh;"></iframe>

This a sound visualizer centered around the middle of the screen. Click the image to start. if it does not load for you try [This Link](https://lukeknight00.github.io/pages/sketches/purpCirc/)
